...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'vConTACT'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from vConTACT.vConTACTImpl import vConTACT  # noqa @IgnorePep8
impl_vConTACT = vConTACT(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'vConTACT'
