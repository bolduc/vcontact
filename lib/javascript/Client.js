...
function vConTACT(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_vcontact = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "vConTACT.run_vcontact",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "vConTACT.status",
